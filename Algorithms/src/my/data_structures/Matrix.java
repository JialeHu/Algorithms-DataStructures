...
public class Matrix {
	...
	if (row >= matrix.length)
	    throw new IllegalArgumentException("Row Number Exceeds Matrix Size");
	...
	if (col >= matrix[0].length)
	    throw new IllegalArgumentException("Column Number Exceeds Matrix Size");
	...
	if (vec1.length != vec2.length)
	    throw new IllegalArgumentException("Vector Not in Same Length");
	int res = 0;
