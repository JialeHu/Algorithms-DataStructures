...
//		System.out.println(count);
	...
	/**
	 * 
	 * @param nums {@code long[]}: Array of numbers to find two numbers sum up to target
	 ...
	 * @param nums {@code long[]}: Array of numbers to find two numbers sum up to target
	 * @param target {@code long}: As a target of two sum
	 * @return {@code boolean true} if nums contains at least one pair of distinct numbers sum up to target
	 */
	 ...
	 * @param nums {@code long[]}: Array of numbers to find two numbers sum up to target
	 * @param target {@code long}: As a target of two sum
	 * @return {@code boolean true} if nums contains only one pair of numbers sum up to target
	 */
	 ...
	 * {@summary }
	 * @param nums {@code long[]}: Array of numbers to find two numbers sum up to target
	 * @param idxList {@code List<int[]>}: List of index pairs for numbers sum up to target
	 */
